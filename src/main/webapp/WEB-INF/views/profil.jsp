...
<div style="max-width: 900px; margin: 0 auto">
  ...
  <div class="flex items-center gap-2 mb-3 animate-fade">
    <div class="profil-avatar">
      <c:choose>
        <c:when test="${utilisateurConnecte.admin}">&#128081;</c:when>
    ...
    <div class="card animate-slide">
      ...
      <c:if test="${not empty succesInfos}">
        <div class="alert alert-success">
          ✅ <c:out value="${succesInfos}" />
        </div>
      </c:if>
      <c:if test="${not empty erreurInfos}">
        <div class="alert alert-danger">
          ⚠️ <c:out value="${erreurInfos}" />
        </div>
      </c:if>
      ...
      >
        ...
        <div class="form-group">
          <label class="form-label" for="adresseLivraison"
            >Adresse de livraison par d&eacute;faut</label
          >
          <textarea
            id="adresseLivraison"
          ...
          >
<c:out value='${utilisateurConnecte.adresseLivraison}'/></textarea
          >
          <span class="form-hint"
            >Sera pr&eacute;-remplie lors de la commande.</span
          >
        </div>
    ...
    <div class="card animate-slide">
      ...
      >
        ...
        <div class="form-group">
          <label class="form-label" for="ancienMotDePasse"
        ...
        <div class="form-group">
          <label class="form-label" for="nouveauMotDePasse"
        ...
        <div class="form-group">
          <label class="form-label" for="confirmerMotDePasse"
      ...
      >
        <p class="text-sm text-muted">
          <strong style="color: var(--green-400)">📅 Membre depuis :</strong
          ><br />
